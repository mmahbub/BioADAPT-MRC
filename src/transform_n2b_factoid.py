# this code is taken from here: https://github.com/dmis-lab/bioasq8b/blob/master/factoid/biocodes/transform_n2b_factoid.py
...
for qid in qidDict:
    ...
    u"id":qid, # must be 24 char
    u"ideal_answer":["Dummy"],
    u"exact_answer":[ans for ans in finalSorted[:5]],
    }
