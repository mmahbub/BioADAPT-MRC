...
data_dir                      = '../BioADAPT-MRC/data/'
output_dir                    = '../BioADAPT-MRC/output/'
output_model_dir              = '../BioADAPT-MRC/model/'
golden_data_folder            = '../BioADAPT-MRC/data/'
java_file_path                = '../BioADAPT-MRC/Evaluation-Measures/flat/BioASQEvaluation/dist/BioASQEvaluation.jar evaluation.EvaluatorTask1b -phaseB -e 5'
